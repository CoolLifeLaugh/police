...
public class LimiterRedisAnnotationAdvisor extends AbstractPointcutAdvisor implements BeanFactoryAware {
    private Advice   advice;
    private Pointcut pointcut;

    public LimiterRedisAnnotationAdvisor(LimiterRedisAnnotationInterceptor advice) {
        this.advice = advice;
    }
