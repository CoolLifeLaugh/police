package com.lhsj.police.core.security;

import com.lhsj.police.core.base.ReExceptions;
import com.lhsj.police.core.number.ReRandoms;
...
public class ReCryptos {
    ...
    private static SecureRandom random = ReRandoms.secureRandom();
    ...
    public static byte[] hmacSha1(byte[] input, byte[] key) {
        try {
            ...
            throw ReExceptions.unchecked(e);
        }
    }
    ...
    public static String aesDecrypt(byte[] input, byte[] key) {
        ...
        return new String(decryptResult, ReCharsets.UTF_8);
    }
