...
import com.lhsj.police.core.concurrent.limiter.ReRateLimiters;
import com.lhsj.police.core.concurrent.limiter.Sampler;
import com.lhsj.police.core.concurrent.limiter.TimeIntervalLimiter;
...
public class ReConcurrents {
    ...
    public static RateLimiter rateLimiter(int permitsPerSecond, int maxBurstSeconds)
        ...
        return ReRateLimiters.create(permitsPerSecond, maxBurstSeconds);
    }
