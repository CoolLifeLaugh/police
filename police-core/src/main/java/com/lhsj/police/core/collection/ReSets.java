package com.lhsj.police.core.collection;

import com.lhsj.police.core.concurrent.ConcurrentHashSet;
...
public class ReSets {
     ...
     */
    public static <T> TreeSet<T> newSortedSet(Comparator<? super T> comparator) {
        return com.google.common.collect.Sets.newTreeSet(comparator);
    }
    ...
    public static <E> Set<E> disjointView(final Set<? extends E> set1, final Set<? extends E> set2) {
        return com.google.common.collect.Sets.symmetricDifference(set1, set2);
    }
}
