...
public class SystemProperties {
    ...
    public static Boolean getBoolean(String name) {
        ...
        return ReBooleans.toBooleanObject(stringResult);
    }
    ...
    public static Boolean getBoolean(String name, Boolean defaultValue) {
        String stringResult = System.getProperty(name);
        return ReBooleans.toBooleanObject(stringResult, defaultValue);
    }
    ...
    public static Double getDouble(String propertyName) {
        return ReNumbers.toDoubleObject(System.getProperty(propertyName), null);
    }
    ...
    public static Double getDouble(String propertyName, Double defaultValue) {
        Double propertyValue = ReNumbers.toDoubleObject(System.getProperty(propertyName), null);
    ...
    public static Integer getInteger(String propertyName, String envName, Integer defaultValue) {
        checkEnvName(envName);
        Integer propertyValue = ReNumbers.toIntObject(System.getProperty(propertyName), null);
        if (propertyValue != null) {
            return propertyValue;
        } else {
            propertyValue = ReNumbers.toIntObject(System.getenv(envName), null);
            return propertyValue != null ? propertyValue : defaultValue;
        }
    }
    ...
    public static Long getLong(String propertyName, String envName, Long defaultValue) {
        checkEnvName(envName);
        Long propertyValue = ReNumbers.toLongObject(System.getProperty(propertyName), null);
        if (propertyValue != null) {
            return propertyValue;
        } else {
            propertyValue = ReNumbers.toLongObject(System.getenv(envName), null);
            return propertyValue != null ? propertyValue : defaultValue;
        }
    }
    ...
    public static Double getDouble(String propertyName, String envName, Double defaultValue) {
        ...
        if (propertyValue != null) {
            ...
            propertyValue = ReNumbers.toDoubleObject(System.getenv(envName), null);
            return propertyValue != null ? propertyValue : defaultValue;
        }
    }
    ...
    public static Boolean getBoolean(String propertyName, String envName, Boolean defaultValue) {
        checkEnvName(envName);
        Boolean propertyValue = ReBooleans.toBooleanObject(System.getProperty(propertyName), null);
        if (propertyValue != null) {
            return propertyValue;
        } else {
            propertyValue = ReBooleans.toBooleanObject(System.getenv(envName), null);
            return propertyValue != null ? propertyValue : defaultValue;
        }
    }
