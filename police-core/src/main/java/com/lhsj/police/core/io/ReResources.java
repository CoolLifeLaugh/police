...
import com.lhsj.police.core.reflect.ReClassLoaders;
...
public class ReResources {
    ...
    public static InputStream asStream(String resourceName) throws IOException {
        return com.google.common.io.Resources.getResource(resourceName).openStream();
    }
    ...
    public static InputStream asStream(Class<?> contextClass, String resourceName) throws IOException {
        return com.google.common.io.Resources.getResource(contextClass, resourceName).openStream();
    }
    ...
    public static String toString(String resourceName) throws IOException {
        return com.google.common.io.Resources.toString(com.google.common.io.Resources.getResource(resourceName), Charsets.UTF_8);
    }
    ...
    public static String toString(Class<?> contextClass, String resourceName) throws IOException {
        return com.google.common.io.Resources.toString(com.google.common.io.Resources.getResource(contextClass, resourceName), Charsets.UTF_8);
    }
    ...
    public static List<String> toLines(String resourceName) throws IOException {
        return com.google.common.io.Resources.readLines(com.google.common.io.Resources.getResource(resourceName), Charsets.UTF_8);
    }
    ...
    public static List<String> toLines(Class<?> contextClass, String resourceName) throws IOException {
        return com.google.common.io.Resources.readLines(com.google.common.io.Resources.getResource(contextClass, resourceName), Charsets.UTF_8);
    }

    ///////////// 打开所有同名文件///////

    public static List<URL> getResourcesQuietly(String resourceName) {
        return getResourcesQuietly(resourceName, ReClassLoaders.getDefaultClassLoader());
    }
