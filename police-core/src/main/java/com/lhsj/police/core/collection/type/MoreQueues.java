package com.lhsj.police.core.collection.type;

import com.google.common.collect.EvictingQueue;
import com.lhsj.police.core.collection.ReQueues;
...
public class MoreQueues {
    ...
    public static <E> Queue<E> createConcurrentStack() {
        return (Queue<E>) Collections.asLifoQueue(ReQueues.newConcurrentNonBlockingDeque());
    }
