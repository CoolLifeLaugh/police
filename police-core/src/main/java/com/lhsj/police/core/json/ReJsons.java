package com.lhsj.police.core.json;
 ...
 * copy from rocketmq
 */
public class ReJsons {

    private static Logger       logger       = LoggerFactory.getLogger(ReJsons.class);
    ...
    public static <T> T string2Obj(String str, TypeReference<T> typeReference) {
        ...
        try {
            ...
            logger.error("Parse String to Object error\nString: {}\nTypeReference<T>: {}\nError: {}", str, typeReference.getType(), e);
            return null;
        }
    }
    ...
    public static <T> T byte2Obj(byte[] bytes, TypeReference<T> typeReference) {
        ...
        try {
            ...
            logger.error("Parse byte[] to Object error\nbyte[]: {}\nTypeReference<T>: {}\nError: {}", bytes, typeReference.getType(), e);
            return null;
        }
    }
     ...
     * @throws IOException
     */
    public static Map<String, Object> convertJsonMap(String jsonStr) throws IOException {
