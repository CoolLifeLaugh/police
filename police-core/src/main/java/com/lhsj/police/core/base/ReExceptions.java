...
import com.lhsj.police.core.io.type.StringBuilderWriter;
import com.lhsj.police.core.type.CloneableException;
import com.lhsj.police.core.type.UncheckedException;
...
public class ReExceptions {
     ...
     *
     * <pre>
     * private static RuntimeException TIMEOUT_EXCEPTION = ReExceptions.setStackTrace(new RuntimeException("Timeout"),
     ...
     * 打印第一行栈的异常信息
     */
    public static String simpleTraceText(@NotNull Throwable t) {
        return simpleTraceText(t, 1);
    }
