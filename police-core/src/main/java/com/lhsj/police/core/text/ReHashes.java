...
public class ReHashes {
    ...
    public static byte[] sha1(@NotNull String input) {
        return digest(input.getBytes(ReCharsets.UTF_8), get(SHA_1_DIGEST), null, 1);
    }
    ...
    public static byte[] sha1(@NotNull String input, @Nullable byte[] salt) {
        return digest(input.getBytes(ReCharsets.UTF_8), get(SHA_1_DIGEST), salt, 1);
    }
    ...
    public static byte[] sha1(@NotNull String input, @Nullable byte[] salt, int iterations) {
        return digest(input.getBytes(ReCharsets.UTF_8), get(SHA_1_DIGEST), salt, iterations);
    }
    ...
    public static int crc32AsInt(@NotNull String input) {
        return crc32AsInt(input.getBytes(ReCharsets.UTF_8));
    }
    ...
    public static long crc32AsLong(@NotNull String input) {
        return crc32AsLong(input.getBytes(ReCharsets.UTF_8));
    }
    ...
    public static int murmur32AsInt(@NotNull String input) {
        return Hashing.murmur3_32(MURMUR_SEED).hashString(input, ReCharsets.UTF_8).asInt();
    }
    ...
    public static long murmur128AsLong(@NotNull String input) {
        return Hashing.murmur3_128(MURMUR_SEED).hashString(input, ReCharsets.UTF_8).asLong();
    }
}
