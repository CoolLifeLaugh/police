package com.lhsj.police.core.cron;
...
public class CronExpression implements Serializable, Cloneable {
    ...
    /**
     * Indicates whether the given date satisfies the cron expression. Note that milliseconds are ignored, so two ReDates falling on different milliseconds of the same second will always have the same
     * result here.
     *
    ...
    /**
     * ReSets the time zone for which this <code>CronExpression</code> will be resolved.
     */
