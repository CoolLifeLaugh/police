 ...
 * <p>
 * 3. 便捷的构造函数(via guava,Java ReCollections，并增加了用数组，List等方式初始化Map的函数)
 * <p>
...
public class ReMaps {
     ...
     * Lazy创建Value值的回调类
     *
     * @see ReMaps#createIfAbsentReturnLast(ConcurrentMap, Object, ValueCreator)
     */
