package com.lhsj.police.core.number;
...
public class ReNumbers {
    ...
    /**
     * copy from ElasticSearch ReNumbers
     */
     ...
     * @param num    值
     */
    public static Integer periodMin(int period, Integer num) {
        if (period <= 0) {
            return 1;
        }
        if (num == null) {
     ...
     * @param num    值
     */
    public static Integer periodMax(int period, Integer num) {
        if (period <= 0) {
            return 1;
        }
        if (num == null) {
